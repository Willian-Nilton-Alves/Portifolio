...
function moveDown(currentSlide) {
  ...
  if (nextSlide.length !== 0) {
    ...
    if (counter % 2 === 0) {
      ...
      TweenMax.to(currentSlideUp, 0.4, {
        y: "-100%",
        delay: 0.15
      });
      TweenMax.to(currentSlideDown, 0.4, {
        y: "100%",
        delay: 0.15
      });
      setTimeout(function () {
    ...
    TweenMax.to(currentCopy, 0.3, {
      autoAlpha: 0,
      delay: 0.15
    });
    TweenMax.to(nextCopy, 0.3, {
      autoAlpha: 1,
      delay: 1
    });
    TweenMax.to(nextSlideUp, 0.4, {
      y: "0%",
      delay: 0.15
    });
    TweenMax.to(nextSlideDown, 0.4, {
      y: "0%",
      delay: 0.15
    });
...
function moveUp(currentSlide) {
  ...
  if (prevSlide.length !== 0) {
    ...
    TweenMax.to(prevCopy, 0.3, {
      autoAlpha: 1,
      delay: 1
    });
    TweenMax.to(prevSlideUp, 0.4, {
      y: "0%",
      delay: 0.15
    });
    TweenMax.to(prevSlideDown, 0.4, {
      y: "0%",
      delay: 0.15
    });
    $(currentSlide).removeClass("active");
